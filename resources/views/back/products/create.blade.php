    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="one_piece_check"
                                    value="1" name="one_piece" checked>
                        ...
                        <div class="mb-3">
                            <div id="newRow1"></div>
                            <button id="addRow1" type="button" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i>
                        ...
                        <div class="mb-3">
                            <div id="newRow2"></div>
                            <button id="addRow2" type="button" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <img width="100" id="img" class="img-fluid mb-1" src="">
                    ...
                    <div class="collapse show" id="collapse_stock">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-12">
                                    <textarea name="stock3" class="form-control" rows="6"></textarea>
                                </div>
                            </div>
            ...
            <div class="col-lg-6 mx-auto d-grid mb-3">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Ürün Ekle</button>
            </div>
        </div>
    </form>
@endsection
