    ...
    <form action="{{ route('admin.pages.store') }}" method="POST">
        <div class="row g-3">
            <div class="col-lg-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white">
                        <span><i class="fas fa-file"></i> Sayfa Bilgileri</span>
                    </div>
            ...
            <div class="col-lg-6 mx-auto d-grid">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Sayfa Oluştur</button>
            </div>
        </div>
    </form>
@endsection
