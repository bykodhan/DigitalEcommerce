            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white">
                        <span><i class="fas fa-edit"></i>"{{$article->title}}" Yazı Düzenle</span>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input id="input_slug" type="text" class="form-control" name="slug"
                                            max="300" required value="{{$article->slug}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control tags" type="text" max="255" name="description" value="{{$article->description}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
