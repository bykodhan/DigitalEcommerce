    ...
    protected function configureRateLimiting()
    {
        ...
        RateLimiter::for('order', function (Request $request) {
            return Limit::perMinute(3)->response(function () {
                return redirect()->back()->with('error', 'Çok fazla deneme yaptınız. Lütfen daha sonra tekrar deneyiniz.');
            });
        });
        RateLimiter::for('coupon_check', function (Request $request) {
            return Limit::perMinute(6)->response(function () {
                return response()->json(['error' => 'Çok fazla deneme yaptınız. Lütfen daha sonra tekrar deneyiniz.']);
            });
        });
    }
}
